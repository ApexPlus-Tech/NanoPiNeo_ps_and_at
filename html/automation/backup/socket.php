...
<?php
	...
	socket_set_option($socket,SOL_SOCKET, SO_RCVTIMEO, array("sec"=>10, "usec"=>0));  //    if it doesn,t get reply from server it will close its connection after 5 sec
	...
	$result = socket_read ($socket, 1024);// or header('Location:guiSocket.php');//it receives the reply from the server even if it fails it will redircted to our gui page for another querry
